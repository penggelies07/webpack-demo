...
const plugins = [
    ...
    new HtmlWebpackPlugin({
        filename: 'index.template.html', // 要将HTML写入的文件。默认为index.html。可以在这里指定一个子目录（如：assets/admin.html）
...
module.exports = () => {
    return {
        ...
        entry: {
            ...
            'other': path.resolve(__dirname, '../src/index.js')
        },
        // 指定输出的路径
        // // 打包单个文件
        // output: {
